    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <nav className="bg-white shadow-sm sticky top-0 z-50">
        <div className="max-w-4xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link href="/pricing" className="text-xs px-3 py-1.5 bg-blue-50 text-blue-600 rounded-full font-semibold">💰 定價</Link>
      ...
      <div className="max-w-4xl mx-auto px-4 py-6 space-y-4">
        ...
        <div className="bg-white rounded-2xl p-5 shadow-sm">
          <div className="font-bold mb-3">🚀 當前方案</div>
          ...
          <div className="text-xs text-gray-400 mt-2">💡 方案切換即時生效，用量重置時間為每天午夜 UTC</div>
        </div>
        ...
        {activeTab === 'usage' && (
          <>
            {/* Today Stats */}
            <div className="bg-white rounded-2xl p-5 shadow-sm">
              <div className="font-bold mb-4">📅 今日使用量</div>
            ...
            {/* Monthly Stats */}
            <div className="bg-white rounded-2xl p-5 shadow-sm">
              <div className="font-bold mb-3">📆 本月使用量</div>
            ...
            {usage && usage.history.length > 0 && (
              <div className="bg-white rounded-2xl p-5 shadow-sm">
                <div className="font-bold mb-4">📈 近 {usage.history.length} 天使用趨勢</div>
        ...
        {activeTab === 'keys' && (
          <div className="space-y-4">
            <div className="bg-white rounded-2xl p-5 shadow-sm">
              <div className="font-bold mb-1">🔑 API Key 管理</div>
              <div className="text-xs text-gray-400 mb-4">
                儲存你的 API Key，下次使用時無需重新輸入。Key 使用 TLS 加密傳輸。
              </div>

              {[
                { engine: 'openai', label: '🎙️ OpenAI', sub: 'GPT-4o Mini TTS', placeholder: 'sk-...' },
                { engine: 'elevenlabs', label: '🎧 ElevenLabs', sub: 'Multilingual v2', placeholder: 'ElevenLabs API Key...' },
                { engine: 'kokoro', label: '🔉 Kokoro / inference.sh', sub: 'inference.sh API', placeholder: 'inference.sh API Key...' },
